		...
		for _, oldOrder := range orderList {
			...
			case "BUY": //CHECK TO SELL BACK
				...
				*/
				...
				if market.Close >= market.UpperBand && market.Close < market.Open && market.Price < market.LastPrice && orderBookBidsBaseTotal < orderBookAsksBaseTotal && market.RSI > float64(80) {
			...
			case "SELL": //CHECK TO BUY BACK
				...
				*/
				...
				if market.Close <= market.LowerBand && market.Close > market.Open && market.Price > market.LastPrice && orderBookBidsBaseTotal > orderBookAsksBaseTotal && market.RSI < float64(20) {
